...
# g++ $target_file usm_api.cpp -o app -std=c++17 -I/usr/local/include/opencv4 -L/usr/local/lib -lOpenCL -g
g++ $target_file -o app -std=c++17 -I/usr/local/include/opencv4 -L/usr/local/lib -lOpenCL -g
